    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-left mb-16">
          <p className="text-amber-600 text-sm font-bold mb-2 uppercase tracking-wider" style={{ fontFamily: 'RF Dewi Extended, sans-serif' }}>CONSTRUCTION SERVICES</p>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-slate-900" style={{ fontFamily: 'RF Dewi Extended, sans-serif' }}>
            Expert Builders<br />Offering Premium Services
          </h2>
          <p className="text-lg text-slate-600 mt-4 max-w-2xl">
            We provide comprehensive building and construction services across the UK, including house extensions, new builds, loft conversions, driveways, and complete renovations.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-slate-700 text-lg mb-6" style={{ fontFamily: 'RF Dewi Extended, sans-serif' }}>
            View our portfolio of completed building projects in our gallery
          </p>
          <Link href="/gallery">
