...
export const metadata: Metadata = {
  ...
  description: 'Contact SK Construction Ltd for a free consultation and quote. Call us at +12 3456789 or email info@skconstructionltd.co.uk. Professional construction services across the UK.',
