...
export default function DashboardPage() {
  ...
  const loadCategories = async () => {
    ...
    try {
      console.log('Fetching from: /api/github/categories');
      ...
      console.error('❌ FAILED: Error loading categories');
      console.error('Error details:', error);
      showMessage('error', `Failed to load categories: ${error instanceof Error ? error.message : 'Unknown error'}`);
